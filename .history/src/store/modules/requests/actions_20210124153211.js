export default {
  ...
  async fetchRequests(context) {
    ...
    const response = await fetch(`https://vue-http-demo-92b0d-default-rtdb.europe-west1.firebasedatabase.app/requests/${coachId}.json`)
    const responseData = await response.json();
    ...
    for (const key in responseData) {
      const request = {
        ...
        userMessage: responseData[key].useressage,
      };
